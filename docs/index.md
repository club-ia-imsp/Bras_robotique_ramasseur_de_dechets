...
- **Carte électronique** reliant les différents composants
...
| Électronique | 🟡 Composants étudiés, intégration en cours |
| Informatique | 🔴 Recherches préliminaires uniquement |

---

Utilisez le menu de navigation pour consulter le **cahier des charges**, la **documentation de la version en cours (2026)**, ou les **versions antérieures** du bras (téléopérées par manette puis par mouvements de la main).
